...
## Detalle técnico
- Endpoint del backend consumido: 
...
- Escenario de prueba (Ej: click en botón X): 
- Resultado esperado (Interacción correcta): 

## Criterios de Aceptación
- [ ] El componente es responsive (Mobile/Desktop check).
- [ ] La integración con el backend funciona sin errores 400/500.
